...
impl Browser {
    ...
    pub fn webview(&self) -> &webkit::WebView {
        &self.webview
    }
...
impl BrowserBuilder {
    ...
    pub fn application(mut self, app: &gtk::Application) -> Self {
        self.window.replace(gtk::ApplicationWindow::new(app));
        self
    }

    pub fn webview(mut self, webview: webkit::WebView) -> Self {
...
fn setup_style(window: &gtk::ApplicationWindow, geometry: Rectangle, debug: bool) {
...
fn setup_actions(window: &gtk::ApplicationWindow, webview: &webkit::WebView, debug: bool) {
    let win_entries = [
        gio::ActionEntry::builder("undo")
            .activate(clone!(
                #[weak]
                webview,
        ...
        gio::ActionEntry::builder("paste")
            ...
            .build(),
        gio::ActionEntry::builder("paste-plain")
            .activate(clone!(
                #[weak]
                webview,
                move |_, _, _| webview
        ...
        gio::ActionEntry::builder("select-all")
            ...
            .build(),
        gio::ActionEntry::builder("zoom-normal")
            .activate(clone!(
                #[weak]
                webview,
        ...
        gio::ActionEntry::builder("reload")
            ...
            .build(),
        gio::ActionEntry::builder("force-reload")
            .activate(clone!(
                #[weak]
                webview,
    ...
    if debug {
        let win_debug_entries = [
            gio::ActionEntry::builder("toggle-inspector")
                .activate(clone!(
                    #[weak]
                    webview,
                    move |_, _, _| {
            ...
            gio::ActionEntry::builder("close")
                ...
                .build(),
            gio::ActionEntry::builder("minimize")
